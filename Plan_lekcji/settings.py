"""
Django settings for Plan_lekcji project.
...
SECRET_KEY = 'django-insecure-j16gy)sxpmuky9c^3sp9x&i^%2r=a&c^t^^fieq8dumuxc#rib'
...
WSGI_APPLICATION = 'Plan_lekcji.wsgi.application'
